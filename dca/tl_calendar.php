...
if($GLOBALS['TL_CONFIG']['rms_active'])
{
	...
	// Subpalettes
	$GLOBALS['TL_DCA']['tl_calendar']['subpalettes']['rms_protected'] = 'rms_master_member,rms_preview_jumpTo';
	...
	$GLOBALS['TL_DCA']['tl_calendar']['fields']['rms_preview_jumpTo'] = array
	(
   ...
   $GLOBALS['TL_DCA']['tl_calendar']['fields']['ptable']['ignoreDiff'] = true;
	...
	$GLOBALS['TL_DCA']['tl_calendar']['fields']['rms_ref_table'] = array
	(
