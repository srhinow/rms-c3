...
if($GLOBALS['TL_CONFIG']['rms_active'])
{
	...
	$GLOBALS['TL_DCA']['tl_calendar']['fields']['rms_protected'] = array
		(
			'label'                   => &$GLOBALS['TL_LANG']['tl_calendar']['rms_protected'],
			'exclude'                 => true,
			'filter'                  => true,
			'inputType'               => 'checkbox',
    ...
    (
		'label'                   => &$GLOBALS['TL_LANG']['tl_calendar']['rms_master_member'],
		'exclude'                 => true,
		'inputType'               => 'select',
	...
	*/
	public function addRmsFields(\DataContainer $dc)
	{
		...
		foreach($GLOBALS['TL_DCA']['tl_calendar']['palettes'] as $name => $field)
        {
			...
			$GLOBALS['TL_DCA']['tl_calendar']['palettes'][$name] .=  ';{rms_legend:hide},rms_protected';
        }
